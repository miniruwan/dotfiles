...
Example:
```mklink C:\Users\minir\AppData\Roaming\Code\User\settings.json C:\dotfiles\vscode\settings.json```

### Keybindings
These keymaps are mainly because some of the default keymaps conflicts with vim plugin's keys. So I've remapped them.
Symlink to this file from the VsCode configuration directory.
Example:
```mklink C:\Users\minir\AppData\Roaming\Code\User\keybindings.json C:\dotfiles\vscode\keybindings.json```
